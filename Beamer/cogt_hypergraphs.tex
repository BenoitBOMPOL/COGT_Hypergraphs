...
\begin{document}
		...
		\begin{columns}
			...
			\begin{column}{0.5\textwidth}
				\begin{enumerate}
					...
					\item <alert@4,10,16,26> Stopping Criterion
	...
	\begin{frame}{Finding \textit{admissible} $(s, t)$-hyperpaths in $R$}
		...
		\begin{tcolorbox}[colback=darkseagreen!5!white,colframe=darkseagreen!75!black,title=Admissible hyperpaths]
			\begin{itemize}[<+->]
				\item Three criteria for $P$ to be an admissible $(s, t)$-hyperpath in $R$:
				\begin{itemize}
					\item[1.] \textit{Stopping Criterion}-related argument
	...
	\begin{frame}{Finding \textit{admissible} $(s, t)$-hyperpaths in $R$}
		...
		\begin{tcolorbox}[colback=darkseagreen!5!white,colframe=darkseagreen!75!black,title=Admissible hyperpaths]
			...
			\begin{itemize}
				\item[1.] Stopping criterion for the main algorithm :
		...
		\begin{itemize}
			\item Stopping criterion : ${\color{caribbeangreen}\mathcal{M}_{-}} = \{V\}$ and ${\color{atomictangerine}\mathcal{M}_{+}} = \{V\}$.
	...
	\begin{frame}{Introduction of $Q^{v}_{+}$}
		...
		\begin{figure}[H]
			...
			\caption*{
				...
				\only<5>{Using Claim 1, $X\cap{V}\in{\color{atomictangerine}\mathcal{T}_{+}}$.}
	...
	\section*{Bonus}
	\begin{frame}{Finding an admissible hyperpath $R\in\mathcal{R}\cap{\color{caribbeangreen}\mathcal{T}_{-}}$}
		\begin{algorithm}[H]
			\begin{algorithmic}[1]
